...
const navItems = [
  { label: 'Home', href: '/' },
  {
    ...
    dropdown: [
      ...
      { label: 'Show Highlights', href: '/show-highlights' },
    ]
  },
  {
    label: 'Exhibitors',
...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <nav className="w-full absolute top-0 left-0 z-[999] transition-all duration-300 bg-transparent pt-6">
        <div className={`max-w-[95rem] mx-auto px-4 md:px-8 flex flex-col lg:flex-row justify-between transition-all duration-300 ${isScrolled ? 'items-center gap-2' : 'items-start gap-6'
          }`}>
          ...
          <div
            className={`hidden lg:flex items-center bg-white rounded-full p-2 shadow-md transition-all duration-300 relative ${isScrolled ? 'lg:mt-0' : 'lg:mt-6'
              }`}
