...
export default function Hero() {
  ...
  return (
    <section
      className="relative w-full h-screen min-h-[850px] lg:min-h-[950px] overflow-hidden bg-gradient-to-b from-[#e8ebed] to-[#d4d8db] flex flex-col items-center pt-32"
        ...
        */}
        ...
        >
          ...
          <div className="text-center z-40 mt-38 md:mt-44 px-2">
            <h2 className="font-heading text-white text-[7vw] sm:text-4xl md:text-5xl lg:text-6xl font-black tracking-tighter mb-1 md:mb-2 drop-shadow-sm whitespace-nowrap">11.12.13 August 2O26</h2>
            <p className="text-[#dae020] text-lg md:text-xl font-medium tracking-tight mb-6 md:mb-8 drop-shadow-sm">Bharat Mandapam, New Delhi</p>
          </div>
