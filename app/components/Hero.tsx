...
export default function Hero() {
  ...
  return (
    <section
      className="relative w-full h-[100dvh] min-h-[650px] lg:min-h-[950px] overflow-hidden bg-gradient-to-b from-[#e8ebed] to-[#d4d8db] flex flex-col items-center pt-32"
    ...
    >
      ...
      <motion.div
        className="absolute top-[12%] sm:top-[-15%] md:top-[-25%] lg:top-[-28%] left-[49.6%] z-20 w-[120vw] max-w-[530px] sm:max-w-none sm:w-[864px] lg:w-[1167px] aspect-[7/8]"
      ...
      <div className="absolute bottom-0 w-full h-[55%] min-h-[350px] lg:h-[680px] z-30">
        ...
        */}
        ...
        <motion.div
          className="absolute bottom-0 left-1/2 w-[160vw] md:w-[120vw] max-w-[2000px] z-30 pointer-events-none"
        ...
        >
          ...
          <div className="absolute top-[8%] sm:top-[20%] md:top-[36%] lg:top-[35%] left-1/2 transform -translate-x-1/2 w-[160px] h-[90px] md:w-[282px] md:h-[158px] lg:w-[338px] lg:h-[190px] rounded-2xl overflow-hidden shadow-2xl bg-white/5 backdrop-blur-sm z-40 group cursor-pointer">
          ...
          {/* Date & Location text */}
          <div className="text-center z-40 mt-28 sm:mt-40 md:mt-44 px-2">
            <h2 className="font-heading text-white text-2xl min-[400px]:text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black tracking-tighter mb-1 md:mb-2 drop-shadow-sm whitespace-nowrap">11.12.13 August 2O26</h2>
            <p className="text-[#dae020] text-sm md:text-xl font-medium tracking-tight mb-4 md:mb-8 drop-shadow-sm">Bharat Mandapam, New Delhi</p>
          </div>

          {/* Buttons Group */}
          <div className="flex items-center bg-[#dae020] rounded-full p-1 sm:p-1.5 shadow-[0_4px_20px_rgba(218,224,32,0.4)] z-40 hover:scale-[1.03] transition-all duration-300 hover:shadow-[0_8px_30px_rgba(218,224,32,0.6)] group w-[90%] sm:w-auto max-w-[340px] sm:max-w-[400px] justify-between sm:justify-center">
