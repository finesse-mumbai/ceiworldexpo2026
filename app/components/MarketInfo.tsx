  ...
  return (
    <section className="pt-20 md:pt-24 pb-20 bg-white text-center">
      <div className="w-full px-4 md:px-8">
        <h2 className="text-3xl md:text-[40px] font-medium tracking-wide mb-10 text-black">India Market Info</h2>
        <p className="text-xl md:text-2xl lg:text-[24px] font-medium leading-[1.6] text-gray-800 tracking-wide mb-8 mx-auto">
        ...
        <p className="text-xl md:text-2xl lg:text-[24px] font-medium leading-[1.6] text-gray-800 tracking-wide mb-12 mx-auto">
