              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="pt-6 flex flex-col items-center justify-center gap-4">
                  ...
                  <p className="text-left text-sm text-slate-500 leading-relaxed mt-4 w-full border-t border-slate-100 pt-4">
                    <strong>Note:</strong> For buyer registrations and related inquiries, please reach out to <strong>Akash Prabhu</strong> at <strong>Mobile: +91-9137587951 </strong> or via email at <strong> akash@worldexindia.com</strong>
                  </p>
                </div>
              </form>
            </div>
