        ...
        <div className="mx-auto max-w-[95rem] px-4 md:px-8">
          ...
          <div className="mt-16 grid gap-12 md:grid-cols-[1fr_2fr]">
            ...
            <form className="space-y-6">
              ...
              <div>
                <div className="mb-3 text-[15px] font-semibold text-black">Interested in:<span className="text-[#009ad7] ml-1">*</span></div>
              ...
              <textarea
                rows={4}
                placeholder="Message"
                className="w-full rounded-md border border-gray-200 bg-white p-3 text-[15px] text-black focus:border-[#009ad7] focus:outline-none transition-colors"
              />

              <button
                type="button"
                className="rounded-full bg-[#009ad7] px-8 py-3 text-[15px] font-semibold text-white transition hover:brightness-110"
              >
                Submit
              </button>
            </form>
